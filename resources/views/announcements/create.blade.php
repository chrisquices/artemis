                ...
                <div class="intro-y box mt-5">
                    <div class="relative flex items-center p-5">
                        ...
                        <div class="ml-4 mr-auto">
                            <div class="font-medium text-base">Add a New Announcement</div>
                    ...
                    <div class="intro-y box lg:mt-5">
                        ...
                        <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-12 gap-x-5">
                                        <div class="col-span-12 xl:col-span-12 mb-4">
                                            ...
                                            <div class="flex flex-col sm:flex-row mt-2">
                                                ...
                                                <div class="form-check mr-5">
                                                    <input id="is_active-2" class="form-check-input" type="radio" name="is_active"
                                                           value="0">
                                        ...
                                        <div class="col-span-6 xl:col-span-6 mb-4">
                                            ...
                                            <input id="submitted_at" type="date"
                                                   ...
                                                   name="submitted_at" value="{{ old('submitted_at') ?? date('Y-m-d') }}" required>
                                            @error('submitted_at')
                                            <div class="text-danger mt-2">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                            ...
                            <div class="justify-end mt-4">
                                ...
                                <a href="{{ route('announcements.index') }}" type="button"
