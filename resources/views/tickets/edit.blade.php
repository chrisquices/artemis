    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box mt-5">
                    <div class="relative flex items-center p-5">
                        ...
                        <div class="ml-4 mr-auto">
                            <div class="font-medium text-base">Edit Ticket #{{ $ticket->id_formatted }}</div>
            ...
            <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                <form action="{{ route('tickets.update', ['ticket' => $ticket->id]) }}" method="POST" autocomplete="off"
                    ...
                    <div class="intro-y box lg:mt-5">
                        ...
                        <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-12 gap-x-5">
                                        <div class="col-span-12 xl:col-span-6 mb-4">
                                            ...
                                            <input id="project_id" type="text"
                                                   class="form-control w-full @error('project_id') border-danger @enderror"
                                                   name="project_id" value="{{ $ticket->project->name }}" disabled>
                                            @error('project_id')
                                        ...
                                        <div class="col-span-12 xl:col-span-6 mb-4">
                                            ...
                                            <select name="reported_by_user_id" id="reported_by_user_id"
                                                ...
                                                @foreach($reporter_users as $reported_by_user)
                                                    <option value="{{ $reported_by_user->id }}" @if($ticket->reported_by_user_id == $reported_by_user->id) selected @endif>{{ $reported_by_user->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-span-12 xl:col-span-6 mb-4">
                                            ...
                                            <select name="assigned_to_user_id" id="assigned_to_user_id"
                                                ...
                                                @foreach($assigned_users as $assigned_to_user)
                                                    <option value="{{ $assigned_to_user->id }}" @if($ticket->assigned_to_user_id == $assigned_to_user->id) selected @endif>{{ $assigned_to_user->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-span-12 xl:col-span-12 mb-3">
                                            ...
                                            <input id="summary" type="text"
                                                   ...
                                                   name="summary" value="{{ $ticket->summary }}" required>
                                            @error('summary')
                                            <div class="text-danger mt-2">{{ $message }}</div> @enderror
                                        </div>
                                        <div class="col-span-12 xl:col-span-12 mb-3">
                                        ...
                                        <div class="col-span-12 xl:col-span-6 mb-4">
                                            ...
                                            <input id="submitted_at" type="date"
                                                   ...
                                                   name="submitted_at" value="{{ $ticket->submitted_at->format('Y-m-d') }}" required>
                                            @error('submitted_at')
                                            <div class="text-danger mt-2">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                            ...
                            <div class="justify-end mt-4">
                                ...
                                <a href="{{ route('tickets.show', ['ticket' => $ticket->id]) }}" type="button"
