                ...
                <div class="intro-y box mt-5">
                    <div class="relative flex items-center p-5">
                        ...
                        <div class="ml-4 mr-auto">
                            <div class="font-medium text-base">Edit {{ $user->name }}</div>
                                            ...
                                            <div class="flex flex-col sm:flex-row mt-2">
                                                ...
                                                <div class="form-check mr-5 mt-2 sm:mt-0">
                                                    <input id="type-1" class="form-check-input" type="radio" name="type"
                                                           value="Administrator" @if($user->type == 'Administrator') checked @endif>
                                                    <label class="form-check-label" for="type-1">Administrator</label>
                                                </div>

                                                <div class="form-check mr-5">
                                                    <input id="type-2" class="form-check-input" type="radio" name="type" value="User"
                                                           @if($user->type == 'User') checked @endif>
                                                    <label class="form-check-label" for="type-2">User</label>
                                                </div>
                                                    ...
                                                    @foreach($roles as $role)
                                                        <div class="form-switch mt-2">
                                                            <input id="role-{{ $role->id }}" type="checkbox" class="form-check-input mr-3"
                                                                   @if(in_array($role->id, $user->roleUsers->pluck('role_id')->toArray())) checked @endif
                                ...
                                <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                    <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            <img class="rounded-md" alt="Profile Picture"
                                                 src="{{ ($user->photo) ? $user->photo_url : asset('assets/images/profile-3.jpg') }}"
                                                 id="photo-preview">
