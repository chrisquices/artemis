                ...
                <div class="intro-y box mt-5">
                    <div class="relative flex items-center p-5">
                        ...
                        <div class="ml-4 mr-auto">
                            <div class="font-medium text-base">Add a New Role</div>
                                                    ...
                                                    <div class="col-span-6 2xl:col-span-6 mb-5">
                                                        ...
                                                        @foreach($permission_category as $permission)
                                                            <div class="form-switch mt-2">
                                                                <input id="permission-{{ $permission->id }}" type="checkbox" class="form-check-input mr-3" name="permission_ids[]" value="{{ $permission->id }}">
