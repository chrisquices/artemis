    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box mt-5">
                    <div class="relative flex items-center p-5">
                        ...
                        <div class="ml-4 mr-auto">
                            <div class="font-medium text-base">Edit {{ $project->name }}</div>
            ...
            <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                <form action="{{ route('projects.update', ['project' => $project->id]) }}" method="POST" autocomplete="off"
                                            ...
                                            <div class="flex flex-col sm:flex-row mt-2">
                                                @foreach($statuses as $status)
                                                    <div class="form-check mr-5">
                                                        <input id="status_id-{{ $status->id }}" class="form-check-input" type="radio"
                                                               name="status_id" value="{{ $status->id }}" @if($status->id == $project->status_id) checked @endif>
                                    ...
                                    <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            <img class="rounded-md" alt="Profile Picture"
                                                 src="{{ ($project->photo) ? $project->photo_url : asset('assets/images/profile-3.jpg') }}"
                                                 id="photo-preview">
