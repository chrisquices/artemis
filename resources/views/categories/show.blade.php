...
@section('content')
    <div class="content">
        <div class="intro-y flex items-center mt-6">
            <h2 class="text-lg font-medium mr-auto">{{ $category->name }}</h2>
        </div>
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400 flex">
                        <div class="flex items-center justify-center">
                            ...
                            <a href="{{ route('categories.edit', ['category' => $category->id]) }}" class="text-primary flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="grid grid-cols-12 gap-x-5">
                                    <div class="col-span-12 xl:col-span-12 mb-4">
                                        ...
                                        <div class="flex flex-col sm:flex-row mt-2">
                                            <div class="form-check mr-5 mt-2 sm:mt-0">
                                                <input id="is_active-1" class="form-check-input" type="radio" name="is_active" value="1" @if($category->is_active) checked @endif disabled>
                                                <label class="form-check-label" for="is_active-1">Active</label>
                                            </div>
                                            <div class="form-check mr-5">
                                                <input id="is_active-2" class="form-check-input" type="radio" name="is_active" value="0" @if(!$category->is_active) checked @endif disabled>
                                    ...
                                    <div class="col-span-12 xl:col-span-6 mb-4">
                                        ...
                                        <input id="name" type="text" class="form-control w-full"
                                               name="name" value="{{ $category->name }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
